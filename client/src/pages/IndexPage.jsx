...
  useEffect(() => {
    axios
      // 🟢 CHANGE: Use an endpoint that ONLY returns published events
      .get("/publishedEvents") 
      .then((response) => {
        console.log("Published Events data:", response.data); 
            ...
            events.map((event) => (
              ...
              >
                ...
                <div className="relative aspect-video">
                  {event.image ? (
                    <img
  // ✅ Replace the old src with this line: ✅
  src={`http://localhost:4000/${event.image.startsWith('/') ? event.image.substring(1) : event.image}`}
  alt={event.title}
